...
const piceCents = 345_99;
console.log(piceCents);
...
console.log(new Date(2037, 10, 19, 15, 23, 5)); // 10 is November
console.log(new Date(2037, 10, 31)); // 10 is November 31 is December 1
...
console.log(future.getTime()); // 2142241380000

console.log(new Date(2142241380000));
